...
import com.pinpinbox.android.util.ImageUtils;
...
/**
 * Created by kevin9594 on 2016/7/7.
 */
public class OkHttpClientManager {
    ...
    public static Response post(String url, Param... params) throws IOException {
        ...
        getInstance().getOKHttp().setConnectTimeout(6, TimeUnit.SECONDS);
        getInstance().getOKHttp().setWriteTimeout(6, TimeUnit.SECONDS);
        getInstance().getOKHttp().setReadTimeout(6, TimeUnit.SECONDS);
    ...
    public static String postAsStringByTimeOut(long time, String url, Param... params) throws IOException {


        getInstance().getOKHttp().setConnectTimeout(time, TimeUnit.MILLISECONDS);
        getInstance().getOKHttp().setWriteTimeout(time, TimeUnit.MILLISECONDS);
        getInstance().getOKHttp().setReadTimeout(time, TimeUnit.MILLISECONDS);
    ...
    public static Response post(String url, File file, String fileKey, Param... params) throws IOException {
        ...
        getInstance().getOKHttp().setConnectTimeout(12000, TimeUnit.SECONDS);
        getInstance().getOKHttp().setWriteTimeout(12000, TimeUnit.SECONDS);
        getInstance().getOKHttp().setReadTimeout(12000, TimeUnit.SECONDS);
