package com.pinpinbox.android.Views.pulltozoomview;
...
import com.pinpinbox.android.Views.JazzyView.JazzyWaterFallView;

/**
 * Created by vmage on 2016/7/27.
 */


public class PullZoomWaterFallViewEx extends PullToZoomBase<JazzyWaterFallView> {
    ...
    public PullZoomWaterFallViewEx(Context context) {
        this(context, null);
    }

    public PullZoomWaterFallViewEx(Context context, AttributeSet attrs) {
        super(context, attrs);
        mScalingRunnable = new ScalingRunnable();

        ((JazzyWaterFallView) mRootView).setOnScrollChangeListener(new OnScrollChangeListener() {
            @Override
...
//        ((JazzyWaterFallView) mRootView).setOnScrollViewChangedListener(new OnScrollViewChangedListener() {
//            @Override
...
//        });
    ...
    @Override
    protected JazzyWaterFallView createRootView(Context context, AttributeSet attrs) {
        JazzyWaterFallView scrollView = new JazzyWaterFallView(context, attrs);
        ...
        public void run() {
            if (mZoomView != null) {
                ...
                if ((!mIsFinished) && (mScale > 1.0D)) {
                    ...
                    f2 = mScale - (mScale - 1.0F) * PullZoomWaterFallViewEx.sInterpolator.getInterpolation(f1);
