package com.pinpinbox.android.Views.NiceSpinner;
...
public class NiceSpinner extends TextView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        int defaultPadding = SizeUtils.dp2px(4);

        setGravity(Gravity.CENTER_VERTICAL | Gravity.LEFT);
        setPadding(SizeUtils.dp2px(16), defaultPadding, defaultPadding,
            defaultPadding);
        setClickable(true);

//        backgroundSelector = typedArray.getResourceId(R.styleable.NiceSpinner_backgroundSelector, R.drawable.click_default);
//        setBackgroundResource(backgroundSelector);
        setBackgroundResource(R.drawable.click_2_0_0_default);
    ...
    public void setBackground(int background){
        popupWindow.setBackgroundDrawable(ContextCompat.getDrawable(getContext(),background));
    }
