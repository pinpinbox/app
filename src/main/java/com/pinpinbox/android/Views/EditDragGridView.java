 ...
 */
@SuppressLint("NewApi")
public class EditDragGridView extends GridView {
	/**
...
//	private Vibrator mVibrator;
	...
	public EditDragGridView(Context context) {
		this(context, null);
	}
	
	public EditDragGridView(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public EditDragGridView(Context context, AttributeSet attrs, int defStyle) {
