...
//        gintama = Bitmap.createBitmap(100,150,Config.RGB_565);

        		gintama = BitmapFactory.decodeResource(getResources(), R.drawable.test);
...
//		heightScreen = dm.heightPixels;
    ...
    public void setTouchCheck(boolean t){
        this.touchCheck = t;
    }
	...
	private boolean matrixCheck() {
		...
		// 缩放比率判断
		if (width < widthScreen / 6 || width > widthScreen * 6) {
			return true;
		}
		// 出界判断
    ...
    public int getwidth(){
       return this.gintama.getWidth();

    }
    public int getheight(){
        return this.gintama.getHeight();
    }
