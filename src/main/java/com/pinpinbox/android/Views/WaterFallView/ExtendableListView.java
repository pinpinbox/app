...
package com.pinpinbox.android.Views.WaterFallView;
        ...
        try {
            ...
            try {
                ...
                if (mItemCount == 0) {
                    ...
                    Log.e(TAG, " throw new IllegalStateException(The content of the adapter has changed but ExtendableListView did not receive a notification. Make sure the content of" +
