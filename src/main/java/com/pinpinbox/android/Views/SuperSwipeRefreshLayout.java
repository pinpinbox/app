...
public class SuperSwipeRefreshLayout extends ViewGroup {
    ...
    private boolean RefreshSetDone = false;
    private float floatScaleX = 0;

    public void setRefreshView(View vRefresh, SmoothProgressBar pbRefresh) {

        this.vRefresh = vRefresh;
        this.pbRefresh = pbRefresh;

        RefreshSetDone = true;

        vRefresh.setVisibility(GONE);
        vRefresh.setScaleX(0);
     ...
     */
    private View vBg;
    private boolean BgImageSetDone = false;
    private float floatBgScaleX = 0;
    private float floatBgScaleY = 0;

    public void setUserBgViewScale(View vBg) {
        this.vBg = vBg;
        BgImageSetDone = true;
    }
...
//        MyLog.Set("e", getClass(), "updateListenerCallBack => distance => " + distance);
        ...
        if (RefreshSetDone) {
            ...
            vRefresh.setScaleX(floatScaleX);
        }
        ...
        if (BgImageSetDone) {
            ...
            if (floatBgScaleX >= 1) {
                vBg.setScaleX(floatBgScaleX);
                vBg.setScaleY(floatBgScaleY);
            } else {
                vBg.setScaleX(1f);
                vBg.setScaleY(1f);
            }
...
//            return handlerPushTouchEvent(ev, action);
    ...
    public void startPinpinboxRefresh() {
        if (RefreshSetDone) {
            vRefresh.setVisibility(GONE);
    ...
    public void stopPinpinboxRefresh() {
        if (RefreshSetDone) {
            vRefresh.setVisibility(VISIBLE);
