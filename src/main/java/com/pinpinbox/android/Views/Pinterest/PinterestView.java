package com.pinpinbox.android.Views.Pinterest;
...
public class PinterestView extends ViewGroup implements View.OnTouchListener {
    ...
    public void setChildViewBackgroundColor(int colorId){
        this.color = colorId;
    }
                ...
                if (PinterestView.this.getVisibility() == VISIBLE) {
                    ...
                    if (nearest != null) {
                        ...
                        for (View view : mChildViews) {
                            if (view != nearest) {
                                ((CircleImageView) view).setFillColor(mContext.getResources().getColor(color));
...
//            getChildAt(i).animate().setDuration(100).translationX(0).translationY(0).scaleX(1).scaleX(1).start();
    ...
    public void switchState() {
        ...
        //other view
        for (int i = 1; i < childCount; i++) {
            ((CircleImageView) getChildAt(i)).setFillColor(mContext.getResources().getColor(color));
