package com.pinpinbox.android.Views.DraggerActivity.DraggerMargin;
...
public class SwipeBackActivityHelper {
    ...
    public void onActivityCreate() {
        ...
        swipeBackLayout.setLayoutParams(new FrameLayout.LayoutParams(w, h-y));
        swipeBackLayout.setY(y);
