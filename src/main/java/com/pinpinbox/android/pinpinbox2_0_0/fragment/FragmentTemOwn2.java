 ...
 */
public class FragmentTemOwn2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tvGuide.setText(R.string.pinpinbox_2_0_0_no_template_own);
...
//        rvTemList.getItemAnimator().setSupportsChangeAnimations(false);
    ...
    private void setRecycler() {
        ...
        adapter = new RecyclerTemListAdapter(getActivity(), p36arraylist, true);
        ...
        ExStaggeredGridLayoutManager manager = new ExStaggeredGridLayoutManager(3, StaggeredGridLayoutManager.VERTICAL);
