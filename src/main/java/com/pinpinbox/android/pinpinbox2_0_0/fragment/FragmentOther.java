 ...
 */
public class FragmentOther extends Fragment implements OnDetailClickListener, ClickDragDismissListener.ActionUpListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rGuideOther = v.findViewById(R.id.rGuideOther);
