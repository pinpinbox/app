...
import com.pinpinbox.android.Widget.HashMapKeyControl;
...
//            doingType = DoToAlbum;
            ...
            if (p68Result.equals("1")) {
                if (lastmodifytime != downloadtime) {
                    ...
                    if (file.exists()) {
                        ...
                        MyLog.Set("d", getClass(), "in client album delete");
                    }
                }
    ...
    private class GetPhotoTask extends AsyncTask<Void, Void, Object> {
        ...
        public GetPhotoTask(String albumid) {
            ...
            if (strJson != null && !strJson.equals("")) {
                try {
                    ...
                    if (p34Result.equals("1")) {
                        ...
                        strAlbumName = PPBWidget.GetStringByJsonObject(object, "title");
                        strAlbumDescription = PPBWidget.GetStringByJsonObject(object, "description");
                        strFirstPaging = PPBWidget.GetStringByJsonObject(object, "firstpaging");
                        strSecondPaging = PPBWidget.GetStringByJsonObject(object, "secondpaging");
