 ...
 */
public class FragmentScanSearch extends Fragment implements SurfaceHolder.Callback, DecodeHandlerInterface, View.OnTouchListener {
...
//        vibrate = true;
    ...
    private void getActivityToSetNoConnect() {
        ...
        if (strActivityName.equals(MainActivity.class.getSimpleName())) {
            ((MainActivity) getActivity()).setNoConnect();
        } else if (strActivityName.equals(AlbumSettingsActivity.class.getSimpleName())) {
            ((AlbumSettingsActivity) getActivity()).setNoConnect();
        }
            ...
            if (getArguments() != null) {
                ...
                if (isReference) {
                    ...
                    if (!s.toString().equals("QR_CODE")) {
                        ((AlbumSettingsActivity) getActivity()).getEdScan().setText(resultString);

                        FragmentTransaction transaction = getActivity().getSupportFragmentManager().beginTransaction();
                        transaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_CLOSE);
                        transaction.remove(fragmentScanSearch);
                        transaction.commit();
                ...
                if (scanLogin) {
                    ...
                    if (s.toString().equals("QR_CODE")) {
                        ...
                        if (businessuser_id == null || businessuser_id.equals("") || businessuser_id.equals("null")) {
                            ...
                            ((LoginActivity) getActivity()).doBusiness(businessuser_id);
                        }
