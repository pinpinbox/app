...
import com.pinpinbox.android.pinpinbox2_0_0.activity.AlbumSettingsActivity;
...
import com.pinpinbox.android.pinpinbox2_0_0.activity.AlbumGroupActivity;
 ...
 */
public class FragmentMyUpLoad extends Fragment implements OnDetailClickListener, ClickDragDismissListener.ActionUpListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linGuideMy = v.findViewById(R.id.linGuideMy);
        tvCreate =  v.findViewById(R.id.tvCreate);
        rvCollect =  v.findViewById(R.id.rvCollect);
    ...
    private void init() {
        ...
        loading = ((MyCollectActivity) getActivity()).getLoading();
...
//        intent.putExtra(Intent.EXTRA_STREAM, u);
    ...
    private void selectShareMode() {
        ...
        popSelectShare.show(((MyCollectActivity) getActivity()).getBackground());
    ...
    private void taskShare() {
        if (ShareDialog.canShow(ShareLinkContent.class)) {
            ...
            shareDialog.registerCallback(
                    ((MyCollectActivity) getActivity()).getCallbackManager(),
    ...
    private void doGetAlbum() {
        if (!HttpUtility.isConnect(getActivity())) {
            ((MyCollectActivity) getActivity()).setNoConnect();
            return;
        }
...
//                    d.getTvDescription().setText();
    ...
    public void onEditClick(final int position) {
        ...
        popEdit.show(((MyCollectActivity) getActivity()).getBackground());
    ...
    public void onCooperationClick(int position) {
        ...
        Intent intent = new Intent(getActivity(), AlbumGroupActivity.class);
        intent.putExtras(bundle);
        startActivity(intent);
        ActivityAnim.StartAnim(getActivity());
    ...
    public void onDestroy() {
        ...
        if (FragmentMeRefresh) {
            ...
            for (Activity ac : activityList) {
                if (ac.getClass().getSimpleName().equals(MainActivity.class.getSimpleName())) {
                    acMain = ac;
                    break;
                }
            }
