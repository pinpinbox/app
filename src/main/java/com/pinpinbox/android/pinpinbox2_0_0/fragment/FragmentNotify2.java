 ...
 */
public class FragmentNotify2 extends Fragment {
    ...
    private EndlessRecyclerOnScrollListener mOnScrollListener = new EndlessRecyclerOnScrollListener() {
        ...
        public void onLoadNextPage(View view) {
            ...
            if (!sizeMax) {
                MyLog.Set("e", FragmentNotify2.class, "onLoad");
                if (isDoingMore) {
                    MyLog.Set("e", FragmentNotify2.class, "正在讀取更多項目");
                    return;
                }
                doMoreData();
            } else {
                ...
                MyLog.Set("e", FragmentNotify2.class, "sizeMax");
            }
        }
...
//                View vHeader = LayoutInflater.from(getActivity().getApplicationContext()).inflate(R.layout.header_update, null);
            ...
            rGoUpdateApp.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    try {
                        ...
                        MyLog.Set("d", FragmentNotify2.class, "open google play app");
                    } catch (android.content.ActivityNotFoundException anfe) {
                        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=" + appPackageName)));
                        MyLog.Set("d", FragmentNotify2.class, "open google play web");
                    }
                }
            });
    ...
    private void protocol87(String limit) {
        ...
        try {
            ...
            MyLog.Set("d", FragmentNotify2.class, "p87strJson => " + strJson);
    ...
    private class MoreDataTask extends AsyncTask<Void, Void, Object> {
        ...
        protected void onPostExecute(Object result) {
            ...
            if (p87Result.equals("1")) {
                ...
                MyLog.Set("e", FragmentNotify2.class, "loadCount => " + loadCount);

                if (loadCount == 0) {
                    MyLog.Set("d", FragmentNotify2.class, "已達最大值");
                    sizeMax = true; // 已達最大值
                    if (!isNoDataToastAppeared) {
                        PinPinToast.ShowToast(getActivity(), R.string.pinpinbox_2_0_0_toast_message_scroll_max);
                        isNoDataToastAppeared = true;
...
//            }
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        if (!isVisible && isResumed()) {
            ...
            MyLog.Set("e", getClass(), "目前看不到 FragmentNotify2");
