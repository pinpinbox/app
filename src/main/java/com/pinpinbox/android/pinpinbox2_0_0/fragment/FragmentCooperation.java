 ...
 */
public class FragmentCooperation extends Fragment implements OnDetailClickListener, ClickDragDismissListener.ActionUpListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rGuideCooperation = v.findViewById(R.id.rGuideCooperation);
