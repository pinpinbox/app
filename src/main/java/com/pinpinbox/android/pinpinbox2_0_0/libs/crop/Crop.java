...
//        Toast.makeText(context.getApplicationContext(), "剪裁失敗", Toast.LENGTH_SHORT).show();

        PinPinToast.showErrorToast(context.getApplicationContext(), R.string.pinpinbox_2_0_0_toast_message_crop_error);
