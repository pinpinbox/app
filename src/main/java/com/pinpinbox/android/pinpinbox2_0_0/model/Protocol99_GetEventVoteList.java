...
public class Protocol99_GetEventVoteList {
    ...
    public Protocol99_GetEventVoteList(Activity mActivity, String user_id, String token, String event_id, String searchKey, List<ItemAlbum> itemAlbumList, TaskCallBack callBack) {
                ...
                case ResultType.SYSTEM_OK:
                    ...
                    if (eventJoinCount == 0) {
                        ...
                        if(eventJoinCount<rangeCount){
                            MyLog.Set("d", Protocol99_GetEventVoteList.class, "項目少於" + rangeCount);
                            sizeMax = true;
                            return;
                        }
