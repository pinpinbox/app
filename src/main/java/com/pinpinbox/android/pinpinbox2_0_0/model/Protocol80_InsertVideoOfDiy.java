...
public class Protocol80_InsertVideoOfDiy extends AsyncTask<Void, Void, Object> {
    ...
    public Protocol80_InsertVideoOfDiy(Activity mActivity, String user_id, String token, String album_id, String video_refer, String video_target, TaskCallBack callBack) {
    ...
    protected Object doInBackground(Void... voids) {
        ...
        try {
            ...
            response = HttpUtility.uploadSubmit(true, Url.P80_InsertVideoOfDiy, putMap(), null);
            MyLog.Set("json", getClass(), response);
    ...
    private Map<String, String> putMap() {
        ...
        map.put(Key.video_refer, video_refer);
        map.put(Key.video_target, video_target);
