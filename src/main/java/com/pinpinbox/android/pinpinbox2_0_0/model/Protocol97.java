 ...
 */
public class Protocol97 extends AsyncTask<Void, Void, Object> {
    ...
    public Protocol97(Activity mActivity, String user_id, String token, String index, String album_id, TaskCallBack callBack) {
