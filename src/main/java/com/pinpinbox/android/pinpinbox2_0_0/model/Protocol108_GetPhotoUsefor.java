...
public class Protocol108_GetPhotoUsefor extends AsyncTask<Void, Void, Object> {
    ...
    public Protocol108_GetPhotoUsefor(Activity mActivity, String user_id, String token, String photo_id, TaskCallBack callBack) {
