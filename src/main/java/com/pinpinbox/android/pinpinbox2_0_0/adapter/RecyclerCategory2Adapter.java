...
public class RecyclerCategory2Adapter extends RecyclerView.Adapter {
    ...
    public RecyclerCategory2Adapter(Activity activity, List<ItemAlbumCategory> albumCategoryList) {
