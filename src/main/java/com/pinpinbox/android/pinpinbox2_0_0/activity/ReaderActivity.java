 ...
 */
public class ReaderActivity extends DraggerActivity implements View.OnClickListener, LocationListener, ClickDragDismissListener.ActionUpListener {
    ...
    private void initView() {
        ...
        svDescription = (ControlSizeScrollView) findViewById(R.id.svDescription);
                    ...
                    private void canExchange(final ItemExchange itemExchange) {
                        ...
                        tvChange.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View vv) {
                                ...
                                Intent intent = new Intent(mActivity, ExchangeInfoActivity.class).putExtras(bundle);
    ...
    private class GetAlbumInfoTask extends AsyncTask<Void, Void, Object> {
        ...
        private void saveToRecent() {
            ...
            for (int i = 0; i < activityList.size(); i++) {
                ...
                if (actName.equals(RecentAlbumActivity.class.getSimpleName())) {
                    ((RecentAlbumActivity) activityList.get(i)).setRecent();
    ...
    private class SendLikeTask extends AsyncTask<String, Integer, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            if (result == 1) {
                ...
                for (Activity ac : activityList) {
                    if (ac.getClass().getSimpleName().equals(AlbumInfoActivity.class.getSimpleName())) {
                        ((AlbumInfoActivity) ac).setIsLike();
                        break;
                    }
                }
...
//                tvLikeCount.setText((count - 1) + "");
                ...
                for (Activity ac : activityList) {
                    if (ac.getClass().getSimpleName().equals(AlbumInfoActivity.class.getSimpleName())) {
                        ((AlbumInfoActivity) ac).setDeleteLike();
                        break;
                    }
                }
