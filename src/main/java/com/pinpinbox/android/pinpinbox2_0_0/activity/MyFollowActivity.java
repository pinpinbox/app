 ...
 */
public class MyFollowActivity extends DraggerActivity implements View.OnClickListener, ChangeTypeListener {
    ...
    private void setRecycler() {
        ...
        rvFollow.addItemDecoration(new SpacesItemDecoration(16, true));
        ...
        adapter.setOnRecyclerViewListener(new RecyclerMyFollowAdapter.OnRecyclerViewListener() {
            ...
            public void onItemClick(int position, View v) {
                ...
                if (SystemUtility.Above_Equal_V5()) {
                    ...
                    Intent intent = new Intent(MyFollowActivity.this, AuthorActivity.class);
