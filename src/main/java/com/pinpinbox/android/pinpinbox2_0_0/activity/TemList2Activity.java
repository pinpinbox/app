 ...
 */
public class TemList2Activity extends DraggerActivity implements View.OnClickListener {
...
//
//
//                Intent intent = new Intent(TemList2Activity.this, TemplateInfoActivity.class);
