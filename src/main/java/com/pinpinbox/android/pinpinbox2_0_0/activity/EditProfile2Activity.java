 ...
 */
public class EditProfile2Activity extends DraggerActivity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tvPassword:
                Intent i1 = new Intent(mActivity, ChangePassword2Activity.class);
                startActivity(i1);
                ActivityAnim.StartAnim(mActivity);
                break;
            ...
            case R.id.tvPhone:
                ...
                Intent i2 = new Intent(mActivity, ChangePhone2Activity.class);
                startActivity(i2);
                ActivityAnim.StartAnim(mActivity);
            ...
            case R.id.tvHobby:
                ...
                Intent i3 = new Intent(mActivity, Hobby2Activity.class);
                i3.putExtras(bundle);
                startActivity(i3);
                ActivityAnim.StartAnim(mActivity);
                break;
