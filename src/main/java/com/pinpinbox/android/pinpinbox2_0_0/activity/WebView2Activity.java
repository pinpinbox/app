 ...
 */
public class WebView2Activity extends DraggerActivity {
    ...
    private void setWeb() {
        ...
        w.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                MyLog.Set("e", WebView2Activity.class, "urlurl => " + url);
...
//                String userId = uri.getQueryParameter(Key.user_id);
//
//                MyLog.Set("e", WebView2Activity.class, "scheme => " + scheme);
//                MyLog.Set("e", WebView2Activity.class, "host => " + host);
//                MyLog.Set("e", WebView2Activity.class, "userId => " + userId);
...
//                view.loadUrl(url);
            ...
            public void onPageFinished(WebView view, String url) {
                ...
                MyLog.Set("d", WebView2Activity.class, "onPageFinished");
