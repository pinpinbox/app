...
import com.pinpinbox.android.pinpinbox2_0_0.fragment.FragmentSelectAudio;
import com.pinpinbox.android.pinpinbox2_0_0.fragment.FragmentSelectPDF;
import com.pinpinbox.android.pinpinbox2_0_0.fragment.FragmentSelectPhoto;
import com.pinpinbox.android.pinpinbox2_0_0.fragment.FragmentSelectVideo;
 ...
 */
public class CreationActivity extends DraggerActivity implements View.OnClickListener, LocationListener, ClickDragDismissListener.ActionUpListener {
    ...
    private FragmentSelectVideo fragmentSelectVideo;
    private FragmentSelectAudio fragmentSelectAudio;
...
//            album_id = "3047";
    ...
    private void setAudioMode(String mode) {
        ...
        switch (mode) {
            ...
            case SINGULAR://單首
                ...
                if (mpBackground != null && mpBackground.isPlaying() && isCustomAudio) {
                    mpBackground.stop();
                }
    ...
    private void clickListener() {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                addPicImg.setOnClickListener(com.pinpinbox.android.pinpinbox2_0_0.activity.CreationActivity.this);
            }
        }, 400);
    ...
    private void addUserClick() {
        if (identity != null) {
            ...
            if (identity.equals("editor")) {
                ...
                Intent intent = new Intent(mActivity, AlbumGroupActivity.class);
    ...
    private void recordingClick() {
        ...
        if (mp3Recorder == null) {
            ...
            if (popSelectAudioFile == null) {
                ...
                tvRecording.setOnTouchListener(new ClickDragDismissListener(vContents, com.pinpinbox.android.pinpinbox2_0_0.activity.CreationActivity.this));
                tvSelectAudioFile.setOnTouchListener(new ClickDragDismissListener(vContents, com.pinpinbox.android.pinpinbox2_0_0.activity.CreationActivity.this));
...
//        view.getLocationInWindow(location); //获取在当前窗口内的绝对坐标
    ...
    private void addVideo() {
        ...
        if (fragmentSelectVideo == null) {
            fragmentSelectVideo = new FragmentSelectVideo();
            fragmentSelectVideo.setArguments(bundle);
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_content, fragmentSelectVideo, fragmentSelectVideo.getClass().getSimpleName()).commit();
        } else {
            getSupportFragmentManager().beginTransaction().show(fragmentSelectVideo).commit();
            fragmentSelectVideo.doGetAlbumContent();
        }
    ...
    private void addPicByFast() {
        ...
        if (fragmentSelectPhoto == null) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_content, fragmentSelectPhoto, fragmentSelectPhoto.getClass().getSimpleName()).commit();
        } else {
            getSupportFragmentManager().beginTransaction().show(fragmentSelectPhoto).commit();
            fragmentSelectPhoto.doGetAlbumContent();
        }
    }
    ...
    private void addPdf() {
        ...
        if (fragmentSelectPDF == null) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_content, fragmentSelectPDF, fragmentSelectPDF.getClass().getSimpleName()).commit();
        } else {
            getSupportFragmentManager().beginTransaction().show(fragmentSelectPDF).commit();
        }
...
//        intent.setFlags(Intent.FLAG_GRANT_PERSISTABLE_URI_PERMISSION);
        ...
        if (fragmentSelectPhoto != null) {
            fragmentSelectPhoto.setFromPPBCamera(true);
        }
...
//                        Toast.makeText(mActivity.getApplicationContext(), "spotlight is started", Toast.LENGTH_SHORT).show();
    ...
    private void refreshCollectAndInfo() {
        ...
        for (int i = 0; i < activityList.size(); i++) {
            ...
            if (activityList.get(i).getClass().getSimpleName().equals(AlbumInfoActivity.class.getSimpleName())) {
                acInfo = activityList.get(i);
            }

            if (activityList.get(i).getClass().getSimpleName().equals(MainActivity.class.getSimpleName())) {
        ...
        if (acCollect != null) {
            ...
            ((FragmentMyUpLoad) ((MyCollectActivity) acCollect).getFragment(FragmentMyUpLoad.class.getSimpleName())).doRefresh();
            MyLog.Set("d", getClass(), "refresh FragmentMyUpLoad");

            ((FragmentCooperation) ((MyCollectActivity) acCollect).getFragment(FragmentCooperation.class.getSimpleName())).doRefresh();
            MyLog.Set("d", getClass(), "refresh FragmentCooperation");
...
//                                     audio_refer 為 system 時為 int id)
                        ...
                        MyLog.Set("e", com.pinpinbox.android.pinpinbox2_0_0.activity.CreationActivity.this.getClass(), "--------------------" + itemAlbum.getAudio_mode());
                        MyLog.Set("e", com.pinpinbox.android.pinpinbox2_0_0.activity.CreationActivity.this.getClass(), "--------------------" + itemAlbum.getAudio_refer());
                        MyLog.Set("e", com.pinpinbox.android.pinpinbox2_0_0.activity.CreationActivity.this.getClass(), "--------------------" + itemAlbum.getAudio_target());

                        //先清空 tvAudioTarget
                        tvAudioTarget.setText("");
                        rCustomControl.setVisibility(View.GONE);
                        ...
                        if (itemAlbum.getAudio_mode().equals(PLURAL)) {
                            ...
                            if (itemAlbum.getAudio_refer().equals("file")) {
                                ...
                                rCustomControl.setVisibility(View.VISIBLE);

                                mp3Path = itemAlbum.getAudio_target();
            ...
            if (p57Result.equals("1")) {
                ...
                if (array != 0) {
                    ...
                    if (jsonArray.length() != thisPosition) {
                        ...
                        rvPhoto.scrollToPosition(thisPosition);
...
//                    d.getTvDescription().setText();
    ...
    private void openFragmentSelectAudio(String audio_mode, int buttonType) {
        ...
        if (fragmentSelectAudio == null) {
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_content, fragmentSelectAudio, fragmentSelectAudio.getClass().getSimpleName()).commit();
        } else {
            fragmentSelectAudio.setAudio_mode(audio_mode);
            fragmentSelectAudio.setButtonType(buttonType);
            getSupportFragmentManager().beginTransaction().show(fragmentSelectAudio).commit();
        }
    ...
    public void onBackPressed() {
        ...
        if (fragmentSelectPhoto != null && fragmentSelectPhoto.isAdded() && fragmentSelectPhoto.isVisible()) {

            getSupportFragmentManager().beginTransaction().hide(fragmentSelectPhoto).commit();

        } else if (fragmentSelectVideo != null && fragmentSelectVideo.isAdded() && fragmentSelectVideo.isVisible()) {

            getSupportFragmentManager().beginTransaction().hide(fragmentSelectVideo).commit();

        } else if (fragmentSelectAudio != null && fragmentSelectAudio.isAdded() && fragmentSelectAudio.isVisible()) {
    ...
    public void onDestroy() {
        ...
        if (fragmentSelectPhoto != null && fragmentSelectPhoto.isAdded()) {
            ...
            getSupportFragmentManager()
                    ...
                    .remove(fragmentSelectPhoto)
                    .commitAllowingStateLoss();
            fragmentSelectPhoto = null;
            MyLog.Set("d", this.getClass(), "移除 => fragmentSelectPicture");
        }

        if (fragmentSelectVideo != null && fragmentSelectVideo.isAdded()) {
            getSupportFragmentManager()
                    .beginTransaction().setTransition(FragmentTransaction.TRANSIT_FRAGMENT_CLOSE)
                    .remove(fragmentSelectVideo)
                    .commitAllowingStateLoss();
            fragmentSelectVideo = null;
            MyLog.Set("d", this.getClass(), "移除 => fragmentSelectVideo");
        }
