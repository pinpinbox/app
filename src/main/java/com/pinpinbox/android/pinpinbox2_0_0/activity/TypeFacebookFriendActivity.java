 ...
 */
public class TypeFacebookFriendActivity extends Activity implements View.OnClickListener, ChangeTypeListener {
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.tvBottom:
                ...
                Intent intent = new Intent(TypeFacebookFriendActivity.this, HobbyActivity.class);
